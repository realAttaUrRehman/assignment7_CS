...
### <a name="get_calculate1"></a>![Method: ](https://apidocs.io/img/method.png "APIMATICCalculator.Tests.Controllers.SimpleCalculatorController.GetCalculate1") GetCalculate1

> TODO: Add a method description


```csharp
Task<double> GetCalculate1(Standard.Models.GetCalculate1Input input)
```
...
```csharp
GetCalculate1Input collect = new GetCalculate1Input();

string operation = "operation";
collect.Operation = operation;

double x = 37.4765174172244;
collect.X = x;

double y = 37.4765174172244;
collect.Y = y;


double result = await simpleCalculator.GetCalculate1(collect);
